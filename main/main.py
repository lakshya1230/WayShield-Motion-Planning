...
import Planner
from PlannerImp import AStarPlanner, RRTPlanner
...
def runtest(mapfile, start, goal, verbose = True):
  ...
  MP = AStarPlanner(boundary, blocks)
  # MP = RRTPlanner(boundary, blocks)
  ...
  collision = CollisionChecker.check_path(path, boundary, blocks)
